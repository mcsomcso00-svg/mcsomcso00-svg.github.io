...
sitemap 拆好之後，別忘了每個 URL 的 hreflang 配對——SemanticLab 語意實驗室的 [hreflang 產生器與 GEO 檢測工具](/zh-hant/geo/) 可以直接產出 HTML 與 sitemap 兩種格式的標籤。下一步是把 GSC 的追蹤也按語言切開，見〈[GSC 如何依語言資料夾分開追蹤](/zh-hant/blog/gsc-multilingual-tracking/)〉；整體架構請回到支柱頁〈[多語言 / 國際 SEO 完整指南](/zh-hant/blog/multilingual-seo-guide/)〉。
