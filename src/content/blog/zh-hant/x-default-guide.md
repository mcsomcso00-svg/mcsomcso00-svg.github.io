...
x-default 只有一行，但每頁都要跟著完整的 hreflang 組合一起輸出——GeoSeoToday的 [hreflang 產生器與 GEO 檢測工具](/zh-hant/geo/) 會在產生標籤時自動附上正確的 x-default，不必再人工判斷格式。搭配〈[hreflang 是什麼？多語言站必備教學](/zh-hant/blog/what-is-hreflang/)〉服用效果更好，完整脈絡見支柱頁〈[多語言 / 國際 SEO 完整指南](/zh-hant/blog/multilingual-seo-guide/)〉。
