...
hreflang 標籤手寫容易漏，SemanticLab 語意實驗室把「全語言＋自我參照＋x-default」的規則做成了免費的 [hreflang 產生器與 GEO 檢測工具](/zh-hant/geo/)，貼上 URL 就能一鍵產出正確標籤。想從架構層面理解多語言站怎麼規劃，請看支柱頁〈[多語言 / 國際 SEO 完整指南](/zh-hant/blog/multilingual-seo-guide/)〉，以及〈[x-default 要指到哪個語言？](/zh-hant/blog/x-default-guide/)〉。
